...
export const TeacherProfileApi = {
  ...
  getTeacherProfile: (id: number | string) => `${BASE_URL}teachersprofile/${id}/`,
  
  // PUT /teachersprofile/{id}/
  updateTeacherProfile: (id: number | string) => `${BASE_URL}teachersprofile/${id}/`,
  
  // PATCH /teachersprofile/{id}/
  patchTeacherProfile: (id: number | string) => `${BASE_URL}teachersprofile/${id}/`,
  
  // DELETE /teachersprofile/{id}/
  deleteTeacherProfile: (id: number | string) => `${BASE_URL}teachersprofile/${id}/`,
...
export const StudentProfileApi = {
  ...
  getStudentProfile: (id: number | string) => `${BASE_URL}studentsprofile/${id}/`,
  
  // PUT /studentsprofile/{id}/
  updateStudentProfile: (id: number | string) => `${BASE_URL}studentsprofile/${id}/`,
  
  // PATCH /studentsprofile/{id}/
  patchStudentProfile: (id: number | string) => `${BASE_URL}studentsprofile/${id}/`,
  
  // DELETE /studentsprofile/{id}/
  deleteStudentProfile: (id: number | string) => `${BASE_URL}studentsprofile/${id}/`,
